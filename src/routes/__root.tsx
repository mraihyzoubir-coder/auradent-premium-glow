...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Auradent Studio is a modern premium dental clinic offering implants, whitening, orthodontics and cosmetic dentistry with precision, comfort and care." },
      { name: "author", content: "Auradent Studio" },
      { property: "og:title", content: "Auradent Studio — Modern Premium Dental Clinic" },
